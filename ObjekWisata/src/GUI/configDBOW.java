...
public class configDBOW {
    ...
    private String url = "jdbc:mysql://localhost:3307/objekwisata";
    ...
    public configDBOW(){}
      ...
      public void tampilLaporan(String laporanFile, String SQL){
        ...
        //===========coding semi manual=========================================
        public void SimpanFilmStatement(int id_wisata, String nama_wisata, String alamat, String kategori, String biaya, String stock){
            try{
                String SQLSimpan = "INSERT INTO wisata (id_wisata,nama_wisata,alamat,kategori,biaya,Stock) VALUES('"+id_wisata+"','"+nama_wisata+"','"+alamat+"','"+kategori+"','"+biaya+"','"+stock+"')";
        ...
        public void SimpanFilmPrepared(int id_wisata, String nama_wisata, String alamat, String kategori, String biaya, int stock){
           
            try{
                 String SQLSimpan = "INSERT INTO wisata (id_wisata,nama_wisata,alamat,kategori,biaya,Stock) VALUES(?,?,?,?,?,?)";
                 PreparedStatement perintah = getKoneksi().prepareStatement(SQLSimpan);
                 perintah.setInt(1, id_wisata );
                 perintah.setString(2, nama_wisata);
                 perintah.setString(3, alamat);
                 perintah.setString(4, kategori);
                 perintah.setString(5, biaya);
                 perintah.setInt(6, stock);
